...
1. Pull the AGS Extend SDK MCP Server container image. For example, with image tag 2025.9.0.

    ```bash
    docker pull ghcr.io/accelbyte/ags-extend-sdk-mcp-server:2025.9.0
    ```
      ...
      "mcpServers": {
        "extend-sdk-mcp-server": {
          ...
          "args": [
            ...
            "-e",
            "CONFIG_DIR",
            "ghcr.io/accelbyte/ags-extend-sdk-mcp-server:2025.9.0"
          ],
          "env": {
...
IMAGE_TAG=2025.9.0    # Matches AGS release, bump patch version for hotfix
