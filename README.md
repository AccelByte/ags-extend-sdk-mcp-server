...
1. Pull the AGS Extend SDK MCP Server container image. For example, with image tag 2025.9.1.
...
IMAGE_TAG=2025.9.1    # Matches AGS release, bump patch version for hotfix
